      ...
      items: [
        {
          ...
          description: "[1주] 헐리우드 듀얼토닝 + 물톡스 + 진정관리 + 모델링팩\n[2주] 피코슈어토닝 + 프리미엄 미백관리 + 시트팩\n [3주] 헐리우드 토닝 + 아기주사 + LDM + 모델링팩 \n [4주] 피코슈어토닝 + 피코포커스 + 크라이오 + 모델링팩 \n [5주] 헐리우드 듀얼토닝 + 라라필 + 진정관리 + 모델링팩 \n [6주] 피코슈어토닝 + 프리미엄 미백관리 + 시트팩 \n [7주] 헐리우드 토닝 + 아기주사 + LDM + 모델링팩 \n [8주] 피코슈어토닝 + 피코 포커스 + 크라이오 + 모델링팩 \n [9주] 헐리우드 듀얼토닝 + 프리미엄 미백관리 + 시트팩 \n [10주] 피코슈어토닝 + LDM 재생관리 + LED + 모델링팩 ",
      ...
      items: [
        {
          ...
          description: "[1주] 피코슈어토닝 + 플래티넘 플라필 + 진정관리 + 모델링팩\n[2주] 피코슈어토닝 + 엑셀V 제네시스 + 이온토 관리 + LED + 모델링팩\n [3주] 피코슈어토닝 + 피코 포커스 + 크라이오 + 모델링팩 \n [4주] 피코슈어토닝 + 엑셀V 제네시스 + LDM 관리 + LED + 모델링팩 \n [5주] 피코슈어토닝 + 헐리우드 듀얼토닝 + 오투덤산소 + 모델링팩 \n [6주] 피코슈어토닝 + 엑셀V 제네시스 + 물톡스 + 진정관리 + LED + 모델링팩 \n [7주] 피코슈어토닝 + ISCE 엑소좀 + LDM + 모델링팩 \n [8주] 피코슈어토닝 + 피코포커스 + 크라이오 + 모델링팩 \n [9주] 피코슈어토닝 + 헐리우드 듀얼토닝 + 오투덤 산소 + 모델링팩 \n [10주] 피코슈어토닝 + 엑셀V 제네시스 + LDM관리 + LED + 모델링팩",
