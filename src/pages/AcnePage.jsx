...
const acneData = {
  sections: [
    {
      title: "프락셀",
      description: "저자극 모공 여드름, 흉터 재생, 피부 탄력개선",
      items: [
        {
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "압출 미포함 + 약처방 + 염증주사 일괄 진행",
          originalPrice: "797,000",
          salePrices: "399,000"
        },
        {
          name: "압출 포함 + 약처방 + 염증주사 일괄 진행",
          originalPrice: "997,000",
          salePrices: "499,000"
        },
        {
          name: "라라빔(라라샷 + 네오빔 - 압출미포함)",
          description: "네오빔과 라라샷의 콤보으로 피지샘을 강하게 열어, 염증완화시 44배대 PTT!\n* 압출유무(+10,000원 추가)",
